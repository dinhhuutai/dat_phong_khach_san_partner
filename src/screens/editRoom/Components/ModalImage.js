import {View, Text, Modal, TouchableOpacity, PermissionsAndroid, Button, Image} from 'react-native';
...
const ModalImage = ({setModalSelectImage, idRoom, setImgs}) => {
  ...
  const handleAddImg = async () => {
    ...
    const hotel = await roomAPI.HandleRoom(
      '/addImageRoom',
      {idRoom: idRoom, linkImg: url},
      'post',
    );
